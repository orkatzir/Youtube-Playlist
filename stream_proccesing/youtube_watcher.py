...
def main():
    ...
    youtube_videos_value_schema = schema_registry_client.get_latest_version("youtube_videos-value") #youtube_schema if i want for telegram
    ...
    for video_item in fetch_playlist_items(google_api_key, youtube_playlist_id):
        ...
        for video in fetch_videos(google_api_key, video_id):
            ...
            producer.produce(
                topic="youtube_videos",#youtube_changes
                key=video_id,
                value={
                    "VIDEO_ID":video["id"],
